...
- 新建 UI 前先看 `src/components` 是否已有可复用组件(GlassCard、LoadingButton、EmptyState、InlineStatus、SkeletonCard、ScoreCard、KeywordTags、SuggestionList、BeforeAfterCompare、ChatBox、ChatMessage、StreamPreview、ToastContainer、MessageBox、FeedbackCard、ListSection)。
